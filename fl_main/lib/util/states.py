...
"""This file defines variety of enumeration classed to support implementing FL sustem.
   Enumeration classes are for  assisting implementation of FL system."""

from enum import Enum, IntEnum

class IDPrefix:
    """It is used to indicate which FL component is referred to in the code, such as agent, aggregator or database"""
    agent = 'agent'
