...
def set_config_file(config_type: str) -> str:
    ...
    """takes the type of the config file, such as db, aggregator or agent, as a  parameter and returns a string of path to the configuration file"""
...
def read_config(config_path: str) -> Dict[str, Any]:
    ...
    """
    """takes config path as a parameter ad returns config info in a dictionary format"""
...
def create_data_dict_from_models(model_id, models, component_id):
    ...
    :return: data_dict containing ML modles
    """
    data_dict = dict()
...
def load_model_file(path: str, name: str) -> Tuple[Dict[str, Any], Dict[str, float]]:
    ...
    """
    """ this fun reads the local model file that takes the given parameters and returns the upickled ml models and performance data in the dict format"""
    fname = f'{path}/{name}'
...
def read_state(path: str, name: str) -> ClientState:
    ...
    """
    """this fun. returns ClinetState (for eg. training or sending)
    """
    fname = f'{path}/{name}'
